...
@section('main-content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#verticalycentered{{ $admin->id }}">
                                                <i class="bx bxs-edit-alt text-white"></i>
                                            </button>
                                            <form action="{{ route('SuperAdmin.Account.Admin.Delete', $admin->user->id) }}"
    ...
    <div class="modal fade" id="addAdmin" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('SuperAdmin.Account.Admin.Store') }}" enctype="multipart/form-data" method="POST"
    ...
    @foreach ($admins as $admin)
        <div class="modal fade" id="verticalycentered{{ $admin->id }}" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="{{ route('SuperAdmin.Account.Admin.Update', $admin->user->id) }}"
