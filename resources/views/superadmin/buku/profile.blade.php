            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <img src="{{ asset('storage/' . $superadmin->foto) }}" alt="Profile" class="rounded-circle">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $superadmin->job }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Alamat</div>
                                    <div class="col-lg-9 col-md-8">{{ $superadmin->alamat }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Nomer Telepon</div>
                                    <div class="col-lg-9 col-md-8">{{ $superadmin->notlp }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Email</div>
                                    <div class="col-lg-9 col-md-8">{{ $superadmin->user->email }}</div>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="alamat" type="text" class="form-control" id="alamat"
                                                value="{{ $superadmin->alamat }}">
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label for="notlp" class="col-md-4 col-lg-3 col-form-label">Nomer
                                            Telepon</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input name="notlp" type="text" class="form-control" id="notlp"
                                                value="{{ $superadmin->notlp }}">
                                        </div>
                                    </div>
