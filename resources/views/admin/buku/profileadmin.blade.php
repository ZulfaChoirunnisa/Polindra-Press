          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">{{$admin->notlp}}</div>
              </div>
            ...
            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
              ...
              <!-- Profile Edit Form -->
              <form action="{{route('Admin.profileadmin.update')}}" enctype="multipart/form-data" method="POST" mul >
              @csrf
              @method('PUT')
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="job" type="text" class="form-control" id="job" value="{{$admin->job}}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="notlp" type="text" class="form-control" id="notlp" value="{{$admin->notlp}}">
                  </div>
                </div>
