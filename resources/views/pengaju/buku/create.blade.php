                        ...
                        <form class="row g-3" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="jumlahHalaman" name="jumlahHalaman"
                                    value="{{ old('jumlahHalaman') }}" required>
                            </div>
                            <div class="col-md-12">
                                <label for="daftarPustaka" class="form-label">Daftar Pustaka</label>
                                <textarea name="daftarPustaka" id="daftarPustaka" rows="5" required class="form-control">{{ old('daftarPustaka') }}</textarea>
                            </div>
                            <div class="col-md-12">
                                <label for="resensi" class="form-label">Resensi Buku</label>
                                <textarea name="resensi" id="resensi" rows="5" required class="form-control">{{ old('resensi') }}</textarea>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="namaPenulis" name="namaPenulis"
                                    value="{{ old('namaPenulis') }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="noTeleponPenulis" class="form-label">No Telefon</label>
                                <input type="text" class="form-control" id="noTeleponPenulis" name="noTeleponPenulis"
                                    value="{{ old('noTeleponPenulis') }}" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="alamatPenulis" name="alamatPenulis"
                                    value="{{ old('alamatPenulis') }}" required>
                            </div>
                            <div class="col-12">
